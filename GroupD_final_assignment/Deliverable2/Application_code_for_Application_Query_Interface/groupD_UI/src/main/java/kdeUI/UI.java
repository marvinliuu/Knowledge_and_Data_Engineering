...
public class UI extends JFrame {
	...
	public UI() {
		...
		comboBox.setBounds(10, 7, 619, 22);
		...
		textField.setBounds(10, 57, 866, 21);
		contentPane.add(textField);
		textField.setColumns(10);
		
		ButtonGroup group = new ButtonGroup();
		JRadioButton rdbtnNewRadioButton = new JRadioButton("XML");
		rdbtnNewRadioButton.setSelected(true);
		rdbtnNewRadioButton.setFont(new Font("微軟正黑體 Light", Font.PLAIN, 13));
		rdbtnNewRadioButton.setBackground(SystemColor.textHighlight);
		rdbtnNewRadioButton.setBounds(629, 31, 127, 20);
		group.add(rdbtnNewRadioButton);
		contentPane.add(rdbtnNewRadioButton);
		JRadioButton rdbtnNewRadioButton_1 = new JRadioButton("result");
		rdbtnNewRadioButton_1.setFont(new Font("微軟正黑體 Light", Font.PLAIN, 13));
		rdbtnNewRadioButton_1.setBackground(SystemColor.textHighlight);
		rdbtnNewRadioButton_1.setBounds(629, 7, 127, 20);
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(rdbtnNewRadioButton.isSelected()==true)
					choices = search(choices,0);
				else
					choices = search(choices,1);
				/*show result in UI*/
				textArea.setText(choices);
			}
	...
	private String search(String param, int i ) {
        ...
        try {
        	/*Spqral executive*/
             ...
             if(i==0) {
            	 ...
            	 /*output String*/
            	 result = ResultSetFormatter.toList(results).toString();
              return result;
        } finally {
            qexec.close();
        }
